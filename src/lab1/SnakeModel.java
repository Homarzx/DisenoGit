...
public class SnakeModel extends GameModel {
	...
	private static final GameTile SNAKE_TILE = new RectangularTile(Color.getColor("Brown"));

	/** Graphical representation of the snake's head */
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(Color.getColor("Brown"));
